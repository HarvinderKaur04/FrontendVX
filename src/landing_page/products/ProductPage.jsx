...
function ProductPage() {
    return ( <>
        ...
        <RightSection ImageUrl="media/images/products-console.png" productName="Console" productDesription="The central dashboard for your VyaparaX account. Gain insights into your trades and investments with in-depth reports and visualisations." learnMore="Learnmore"/>
