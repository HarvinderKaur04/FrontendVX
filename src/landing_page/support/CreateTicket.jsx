        ...
        <section className="container-fluid" id="supportHero">
            ...
            <div className="row p-5 mb-5 " id="supportWrapper">
                ...
                <div className="col-6">
                    <h3>Featured</h3>
                    <ol type="1" >
                        <li className="mb-4 mt-4"><a href="">Introduction of new F&O contracts on 4 individual securities </a></li>
                        <li className="mb-4"> <a href="">Rights Entitlements listing in May 2025</a></li>
                    </ol>
                    <a href=""></a>
                </div>
            </div>
